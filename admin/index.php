...
if (!defined('SYS_PATH') || !defined('SITE_PATH')) {
...
set_include_path(SYS_PATH .'admin/cp/'. PATH_SEPARATOR . CORE_PATH . PATH_SEPARATOR . SYS_PATH .'libs/'. PATH_SEPARATOR . SYS_PATH .'includes/core/'. PATH_SEPARATOR . SYS_PATH .'includes/fns/'. PATH_SEPARATOR . SYS_PATH .'includes/languages/'. PATH_SEPARATOR . $incPath);
...
require_once SYS_LANG .'/lang.cp.core.php';
