...
function suggestions(id, autocomplete_location)
{
	$(id).autocomplete({
		serviceUrl: autocomplete_location,
		minChars:1,
		width: 200,
		maxHeight:200,
		delimiter: /(,|;)\s*/,
...
$(document).ready(function() {
	...
	// sugenstii pentru inputs
	suggestions('#struct_search', ROOT+'models/ajax/autocomplete-ateco.php');
