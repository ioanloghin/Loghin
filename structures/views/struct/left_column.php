...
<ul id="myUL">
  ...
  <?php $results = MYSQL_QUERY("SELECT max(a.lvl) FROM `struct_blocks` a WHERE a.`project` = '".$projectID."'");
    ...
    ?>
 <!-- <li><span class="caret">Category1</span>
    <ul class="nested m-ul">
      <li>
          <span class="caret">
        ...
        <ul class="nested">
          <li>
            <span class="caret"><span class="icon ic">&nbsp;</span>Category3</span>
            <ul class="nested">
              <li>
                  <span class="caret">
                      <span class="icon ic">&nbsp;</span>Category4
                  </span>
                  <ul class="nested">
                    <li>
                        <span class="caret">
                        ...
                        <ul class="nested">
                            <li>
                                <a href="#">
                                    <span class="icon ic">&nbsp;</span>Category6
                                </a>
                            </li>
...
<br />
<div class="deep_menu" style="margin-bottom:6px;">CATEGORII:<a<?php echo ($blockID) ? ' class="selected"' : NULL;?> href="<?php echo anchor('struct', 'graph',  $projectID, 2, $deep, $direction);?>">UNA</a> | 
<a<?php echo (!$blockID) ? ' class="selected"' : NULL;?> href="<?php echo anchor('struct', 'graph',  $projectID, 0, $deep, $direction);?>">TOATE</a></div>
<div class="deep_menu">AD&Acirc;NCIME:
<a<?php echo ($deep == 1) ? ' class="selected"' : NULL;?> href="<?php echo anchor('struct', 'graph',  $projectID, $blockID, 1, $direction);?>">1</a> | 
<a<?php echo ($deep == 2) ? ' class="selected"' : NULL;?> href="<?php echo anchor('struct', 'graph',  $projectID, $blockID, 2, $direction);?>">2</a> | 
<a<?php echo ($deep == 3) ? ' class="selected"' : NULL;?> href="<?php echo anchor('struct', 'graph',  $projectID, $blockID, 3, $direction);?>">3</a> | 
<a<?php echo ($deep == 4) ? ' class="selected"' : NULL;?> href="<?php echo anchor('struct', 'graph',  $projectID, $blockID, 4, $direction);?>">4</a> | 
<a<?php echo ($deep == 5) ? ' class="selected"' : NULL;?> href="<?php echo anchor('struct', 'graph',  $projectID, $blockID, 5, $direction);?>">5</a></div>
<br /><br />
<div class="deep_menu" style="margin-bottom:6px;">ORIENTARE:<br />
<a<?php echo ($direction == 1) ? ' class="selected"' : NULL;?> href="<?php echo anchor('struct', 'graph',  $projectID, $blockID, $deep, 1);?>">TIP 1 (Verticala)</a><br /> 
<a<?php echo ($direction == 2) ? ' class="selected"' : NULL;?> href="<?php echo anchor('struct', 'graph',  $projectID, $blockID, $deep, 2);?>">TIP 2 (orizontala)</a></div>
<br />
<script>
