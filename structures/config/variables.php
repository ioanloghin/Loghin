...
$config['debug'] = '1';
$config['cp_url'] = 'http://site.com/system/index.php';
...
$config['avatar_url'] = 'http://site.com/images/avatars/';
...
{
	$config['base_url'] = 'http://localhost/clienti/structures/';
}
else if($_SERVER['HTTP_HOST'] == 'www.loghin.com' || $_SERVER['HTTP_HOST'] == 'loghin.com')
{
	$config['base_url'] = 'http://loghin.com/structures/';
}
else if($_SERVER['HTTP_HOST'] == 'www.structures.loghin.com' || $_SERVER['HTTP_HOST'] == 'structures.loghin.com')
{
	$config['base_url'] = 'http://structures.loghin.com/';
}
...
$config['captcha_path'] = '/path/images/captchas/';
$config['captcha_rand'] = 'y';
$config['captcha_require_members'] = 'n';
$config['captcha_url'] = 'http://site.com/images/captchas/';
...
$config['emoticon_path'] = 'http://site.com/images/smileys/';
$config['emoticon_url'] = 'http://site.com/images/smileys/';
...
$config['is_site_on'] = 'y'; // easy way to disable your site
...
$config['theme_folder_path'] = '/path/themes/';
$config['theme_folder_url'] = 'http://site.com/themes/';
...
$config['webmaster_email'] = 'admin@site.com';
