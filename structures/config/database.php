...
if($_SERVER['HTTP_HOST'] == 'localhost')
{
	...
	define("MYSQL_PAROLA",	"");
	define("BAZA_DATE",		"loghin_structures");
	define("MYSQL_PRE",		"struct_");
...
// --- AGenealogi DB ----------------------------------------------------------------------------------------------------- //
	define("DBT_FAM_INFO", MYSQL_PRE."families");// tabelul cu detalii despre familie
		define("DBT_FAM_INFO_C1", "FamilyID");// id-ul familiei
	...
	define("DBT_FAM", MYSQL_PRE."families_members");// tabelul famililor
		define("DBT_FAM_C1", "id_family");// id unic de inregistrare
		define("DBT_FAM_C2", "TreeID");// id arbore
	...
	define("DBT_TREE", MYSQL_PRE."trees");// tabelul arborilor
		define("DBT_TREE_C1", "TreeID");// id unic de intregistrare
		define("DBT_TREE_C2", "AdminID");// id admin
		define("DBT_TREE_C3", "Label");// numele arborelui
		define("DBT_TREE_C4", "DefaultUser");// idul membrului care v-a avea perspectiva in mod implicit (daca nu s-a specificat altul)
	...
	define("DBT_TREE_LINK", MYSQL_PRE."trees_links");// tabelul legaturilor cu ex relatiile
		define("DBT_TREE_LINK_C1", "LinkID");// id unic de inregistrare
		define("DBT_TREE_LINK_C2", "id_tree1");// id arbore primar
		define("DBT_TREE_LINK_C3", "id_family1");// id familie din arborele primar
		define("DBT_TREE_LINK_C4", "id_user1");// id user din arborele primar
		define("DBT_TREE_LINK_C5", "id_tree2");// id arbore secundar
		define("DBT_TREE_LINK_C6", "id_family2");// id familie din arborele secundar
		define("DBT_TREE_LINK_C7", "id_user2");// id user din arborele secundar
