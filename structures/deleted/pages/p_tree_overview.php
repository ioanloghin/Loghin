<div id="AG_PageLeftBox">
        <?php include('modules/b_tree_leftmenu.php');?>
    </div>
    <div id="AG_PageRightBox">
    	<br />
                ...
                <div class="fp-desc-box" style="margin-top:10px;">
                    ...
                    <div class="fp-desc-box-content">
                        ...
                        <ul class="itemProfilGrup">
                            ...
                            $temp_row = $temp[1];
                            echo item_profil_3($temp_row[DBT_FAM_C6]);
                            echo item_profil_3($temp_row[DBT_FAM_C7], 'last');
                            unset($temp);
						?>
                        </ul>
                        ...
                        <?php
							...
							if($id_copii != NULL && $id_copii != "-$AGmyIDUser-")
                            {
                                ...
                                {
                                    echo item_profil_3($id_copil, (($cnt == ++$n) ? true : false));
                                }
                            }
                            else
                        ...
                        <ul class="itemProfilGrup">
							...
							if(isset($temp[1][DBT_FAM_C6]) && isset($temp[1][DBT_FAM_C7]))
							{
								if($temp[1][DBT_FAM_C6] == $AGmyIDUser)
									echo item_profil_3($temp[1][DBT_FAM_C7], true);
								else
									echo item_profil_3($temp[1][DBT_FAM_C6], true);
							}
							else
