...
class AG_FamilyBox
{
	...
	public function HTMLcode($display = 'block')
	{
		...
		$background_image = ROOT.'codes/AG_FamilyBoxLines.php';
		...
		if($this->recognition['type'] == 1)
		{
			...
			if($this->members_ref[1]->info[DBT_USER_INFO_C1] > 0)
			{
				...
				$html_code .= '<div class="agFamilyBoxExRelButtons" style="width:'.AGFORMAT_T1_EX_W.'px; height:'.AGFORMAT_T1_EX_H.'px; margin-left:'.($this->members_ref[1]->marginLeft-AGFORMAT_T1_EX_W).'px; margin-top:'.$this->members_ref[1]->marginTop.'px; background-image:url('.ROOT.'codes/AG_FamilyBoxLines.php?familyType=1&amp;familyAlign=1&amp;familyWidth='.AGFORMAT_T1_EX_W.'&amp;familyHeight='.AGFORMAT_T1_EX_H.'&amp;exRelatii='.$c1.'&amp;option=2);">';
				for($n=5; $n>=1; $n--)
				{
			...
			if($this->members_ref[2]->info[DBT_USER_INFO_C1] > 0)
			{
				...
				$html_code .= '<div class="agFamilyBoxExRelButtons" style="width:'.AGFORMAT_T1_EX_W.'px; height:'.AGFORMAT_T1_EX_H.'px; margin-left:'.($this->members_ref[2]->marginLeft+AGFORMAT_T1_UBW).'px; margin-top:'.$this->members_ref[2]->marginTop.'px; background-image:url('.ROOT.'codes/AG_FamilyBoxLines.php?familyType=1&amp;familyAlign=2&amp;familyWidth='.AGFORMAT_T1_EX_W.'&amp;familyHeight='.AGFORMAT_T1_EX_H.'&amp;exRelatii='.$c2.'&amp;option=2);">';
				for($n=5; $n>=1; $n--)
				{
					$marginT = ($n == 5) ? 'margin-top:7px;' : '';
