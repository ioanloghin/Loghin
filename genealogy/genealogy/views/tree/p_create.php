    	...
    	<div class="leftColumn clear rad5-top" style="background-color:#E7DCCA;">
            ...
            <div class="right rad5-top-right">
				...
				if($POST->get_successful())
					echo '<div style="margin:87px 10px 70px 0; text-align:center;"><strong style="color:black;">Arborele a fost cu succes!!!<br /><br /><a style="color:blue;" href="'.anchor('tree', 'graph', $params['tree_id'], $params['member_id']).'">Vezi arborele genealogic</a></strong></div>';
				else
				{
					?>
                    <form method="post" action="" class="clean_form clear">
                        ...
                        <fieldset class="<?php echo ($readonly) ? ' opacity40' : NULL;?>">
                            ...
                            if($MyUser->logged())
                            {
                                ...
                                <div class="field_box " style="line-height:26px;"> <strong><?php echo $MyUser->get_loghin_id(); ?></strong> <a href="#">Schimb&#259;</a></div>
                            ...
                            else
                            {
                                ?>
                                <label>Username:</label>
                                <div class="field_box rad3"><input<?php echo ($readonly) ? ' readonly="readonly"' : NULL;?> class="field size rad3" name="username" type="text" value="<?php echo $POST->get_var('username', 'post|sess', TRUE);?>" /></div>
                                <div class="error_box"><p class="info">&nbsp;</p></div>
                                <div class="cleft" style="height:5px;"></div>
                                
                                <label>Password:</label>
                                <div class="field_box rad3"><input<?php echo ($readonly) ? ' readonly="readonly"' : NULL;?> class="field size rad3" name="password" type="password" value="<?php echo $POST->get_var('password', 'post|sess', TRUE);?>" /></div>
                                <div class="error_box"><p class="info">&nbsp;</p></div>
                                <div class="cfix"></div>
                                <div class="cleft" style="height:5px;"></div>
                                <label>Repeat password:</label>
                                <div class="field_box rad3"><input<?php echo ($readonly) ? ' readonly="readonly"' : NULL;?> class="field size rad3" name="re_password" type="password" value="<?php echo $POST->get_var('re_password', 'post|sess', TRUE);?>" /></div>
                                <div class="error_box"><p class="info">&nbsp;</p></div>
                                <div class="cfix"></div>
                                <div class="cleft" style="height:5px;"></div>
                                
                                <label>Email:</label>
                                <div class="field_box rad3"><input<?php echo ($readonly) ? ' readonly="readonly"' : NULL;?> class="field size rad3" name="email" type="text" value="<?php echo $POST->get_var('email', 'post|sess', TRUE);?>" /></div>
                                <div class="error_box"><p class="info">&nbsp;</p></div>
                                <div class="cfix"></div>
                                <div class="cleft" style="height:5px;"></div>
                                <?php
                        ...
                        <fieldset>
                            ...
                            <div class="field_box rad3"><input class="field size rad3" name="family_name" type="text" value="<?php echo $POST->get_var('family_name', 'post|sess');?>" /></div>
                            <div class="error_box"><p class="info">First and/or middle or middle initial</p></div>
                            <div class="cleft" style="height:5px;"></div>
                            
                            <label>Profile Type:</label>
                            <div class="radio_box rad3"><input id="ptype_1" type="radio" name="type" value="public" /><label for="ptype_1">Public</label><input id="ptype_2" type="radio" name="type" value="private" /><label for="ptype_2">Private</label></div>
                            <div class="error_box"><p class="info">First and/or middle or middle initial</p></div>
                            <div class="cfix"></div>
                            <div class="cleft" style="height:5px;"></div>
                        ...
                        <!--<div id="FamilyMembers">
                            <fieldset>
                                ...
                                <div class="field_box rad3"><input<?php echo ($readonly) ? ' readonly="readonly"' : NULL;?> class="field size rad3" name="firstname" type="text" value="<?php echo $POST->get_var('firstname', 'post|sess');?>" /></div>
                                <div class="error_box"><p class="info">&nbsp;</p></div>
                                <div class="cleft" style="height:5px;"></div>
                                
                                <label>Last Name:</label>
                                <div class="field_box rad3"><input<?php echo ($readonly) ? ' readonly="readonly"' : NULL;?> class="field size rad3" name="lastname" type="text" value="<?php echo $POST->get_var('lastname', 'post|sess');?>" /></div>
                                <div class="error_box"><p class="info">&nbsp;</p></div>
                                <div class="cfix"></div>
                                <div class="cleft" style="height:5px;"></div>
                        ...
                        <fieldset style="margin-left:183px; width:260px;" class="clear">
                            ...
                            <div class="submit_box1 rad3" style="width:100px; margin:10px auto 0 auto;"><button class="gradBlueButton rad3" name="register">save</button></div>
