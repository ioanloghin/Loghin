...
class ST_Block
{
	...
	{
		$html_code = '<div id="StructBlock-'.$this->code.'" class="block opacity90" style="width:'.$this->width.'px; height:'.$this->height.'px; margin-left:'.$this->left.'px; margin-top:'.$this->top.'px;">';
		$html_code .= '<span ondblclick="return false;" style="width:'.$this->width.'px; height:'.$this->height.'px;"><!--#'.$this->id.'--> '.$this->label.'</span>';
		$html_code .= '</div>';
