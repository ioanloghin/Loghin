...
$config['avatar_url'] 					= 'http://genealogy.loghin.com/images/avatars/';
...
|
*/
$config['base_url'] = 'http://genealogy.loghin.com/';
...
$config['db_user']		= 'loghin_genealogy';
$config['db_pass']		= 'ertyum';
$config['db_name']		= 'loghin_genealogy';
$config['db_pre']		= 'gen_';

$config['db2_server']	= 'localhost';
$config['db2_user']		= 'loghin_register';
$config['db2_pass']		= 'WZOKyMSe^bGy';
