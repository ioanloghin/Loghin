...
foreach($arrayFamilyObj as $id_family => $family_obj)
{
	if($family_obj->identifier['this'] || $family_obj->identifier['this'] == '0')
	{
		...
		if($family_obj->members_ref[1])
			echo $family_obj->members_ref[1]->info[DBT_USER_INFO_C1];
		else
			echo 0;
		echo ";\n";
		...
		if($family_obj->members_ref[2])
			echo $family_obj->members_ref[2]->info[DBT_USER_INFO_C1];
		else
			echo 0;
		echo ";\n";
		...
		foreach($family_obj->members_ref[3] as $key => $userbox)
		{
			...
			if($userbox)
				echo $userbox->info[DBT_USER_INFO_C1];
			else
				echo 0;
			echo ";\n";
		}
...
function members_js_info(&$member_obj)
{
	...
	//
	$return = NULL;
	$return .= 'AGMembers[\''.$member_obj->info[DBT_USER_INFO_C1].'\'] = new Array();'."\n";
		
	$return .= 'AGMembers[\''.$member_obj->info[DBT_USER_INFO_C1].'\'][\'internalRelation\'] = new Array();'."\n";
	$return .= 'AGMembers[\''.$member_obj->info[DBT_USER_INFO_C1].'\'][\'internalRelation\'][\'id\'] = '.$member_obj->internalRelation['id'].';'."\n";
	$return .= 'AGMembers[\''.$member_obj->info[DBT_USER_INFO_C1].'\'][\'internalRelation\'][\'index\'] = '.$member_obj->internalRelation['index'].';'."\n";
	
	$return .= 'AGMembers[\''.$member_obj->info[DBT_USER_INFO_C1].'\'][\'thisFamily\'] = new Array();'."\n";
	$return .= 'AGMembers[\''.$member_obj->info[DBT_USER_INFO_C1].'\'][\'thisFamily\'][\'id\'] = '.$member_obj->family_obj['ids']['this'].';'."\n";
	$return .= 'AGMembers[\''.$member_obj->info[DBT_USER_INFO_C1].'\'][\'thisFamily\'][\'type\'] = '.$member_obj->family_obj['recognition']['type'].';'."\n";
	$return .= 'AGMembers[\''.$member_obj->info[DBT_USER_INFO_C1].'\'][\'thisFamily\'][\'align\'] = "'.$member_obj->family_obj['recognition']['align'].'";'."\n";
	
	$return .= 'AGMembers[\''.$member_obj->info[DBT_USER_INFO_C1].'\'][\'ascFamily\'] = new Array();'."\n";
	$return .= 'AGMembers[\''.$member_obj->info[DBT_USER_INFO_C1].'\'][\'ascFamily\'][\'id\'] = '.$member_obj->ascFamily['id'].';'."\n";
	$return .= 'AGMembers[\''.$member_obj->info[DBT_USER_INFO_C1].'\'][\'ascFamily\'][\'identifier\'] = "'.$member_obj->ascFamily['identifier'].'";'."\n";
	$return .= 'AGMembers[\''.$member_obj->info[DBT_USER_INFO_C1].'\'][\'ascFamily\'][\'checked\'] = "'.$member_obj->ascFamily['checked'].'";'."\n";
	$return .= 'AGMembers[\''.$member_obj->info[DBT_USER_INFO_C1].'\'][\'ascFamily\'][\'readonly\'] = "'.$member_obj->ascFamily['readonly'].'";'."\n";
	
	$return .= 'AGMembers[\''.$member_obj->info[DBT_USER_INFO_C1].'\'][\'descFamily\'] = new Array();'."\n";
	$return .= 'AGMembers[\''.$member_obj->info[DBT_USER_INFO_C1].'\'][\'descFamily\'][\'id\'] = '.$member_obj->descFamily['id'].';'."\n";
	$return .= 'AGMembers[\''.$member_obj->info[DBT_USER_INFO_C1].'\'][\'descFamily\'][\'identifier\'] = "'.$member_obj->descFamily['identifier'].'";'."\n";
	$return .= 'AGMembers[\''.$member_obj->info[DBT_USER_INFO_C1].'\'][\'descFamily\'][\'checked\'] = "'.$member_obj->descFamily['checked'].'";'."\n";
	$return .= 'AGMembers[\''.$member_obj->info[DBT_USER_INFO_C1].'\'][\'descFamily\'][\'readonly\'] = "'.$member_obj->descFamily['readonly'].'";'."\n";
