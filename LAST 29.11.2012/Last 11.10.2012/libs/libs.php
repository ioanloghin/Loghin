...
/* Get variables */
$m = isset($_GET['m']) && file_exists(SYS_PATH . 'libs/lib.'. $_GET['m'] .'.php') ? $_GET['m'] : (isset($_SERVER['HTTP_X_REQUESTED_WITH']) && $_SERVER['HTTP_X_REQUESTED_WITH'] == 'XMLHttpRequest' ? 'ajax' : 'home');
