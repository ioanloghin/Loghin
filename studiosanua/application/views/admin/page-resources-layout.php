...
<body>
    ...
    <hgroup>
		<div class="btn-group" style="float:right;">
			...
			<a href="<?php echo base_url('resourcespage/layout/'.$item_key.'/'.$l['lang']);?>" type="button" class="btn btn-xs <?php echo $form_lang==$l['lang']?'btn-warning':'btn-default'; ?>"><?php echo $l['lang']; ?></a>
		...
		<div class="panel panel-default col-xs-12 col-sm-6 nopadding">
        	<div class="panel-body nopadding" style="padding:5px;">
                ...
                <div class="col-sm-4 nopadding">
                	<a href="<?php echo base_url('/resourcespage/layout/leftmenu/'.$form_lang);?>" class="layoutSection" style="height:150px;line-height:150px;margin-right:10px;">
                    <div class="visible_icon<?php echo $visible_leftmenu?' hide':'';?>" title="Not visible"></div>
                    Left menu</a>
                </div>
                <div class="col-sm-8 nopadding">
                	<a href="<?php echo base_url('/resourcespage/layout/content/'.$form_lang);?>" class="layoutSection" style="height:150px;line-height:150px;">
