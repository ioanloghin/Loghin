...
<div class="line clear" style="display:flex;">
	<?php if($logged):?>
    <!--<div class="left">
        <a href="#">Login In</a> &nbsp;|&nbsp;
        <a href="#">Sign Up</a> &nbsp;|&nbsp;
        <a href="http://documents.loghin.com/">Documents Data Base</a>
    </div>-->
    <div class="left nav100" style="width:100%;display:flex;">
        <!-- changer -->
    ...
    <div class="right" style="width:200px;">
        ...
        &nbsp;|&nbsp;-->
        <select id="TopLangSelect" class="inputCombo" name="language">
            <?php foreach($languages as $l): ?>
            <option<?php echo $l['lang']==$current_lang?' selected':''; ?> value="<?php echo $l['lang'];?>"><?php echo $l['lang'];?></option>
            <?php endforeach; ?>
        </select>
        <script>
        $('#TopLangSelect').on('change', function() {
            window.location = '/lang/change/'+$(this).val();
        });
        </script>
    </div>
    <?php else:?>
