    ...
    <body style="min-width: 100vw !important;">
    	...
    	<div id="header">
        	<div class="width clear">
                ...
                <div class="dropdown">
                 <button style="color:black;text-decoration:none;">{$loghin_id}</button>
                  <div class="dropdown-content">
                  <a href="https://blog.hubspot.com/">Inbox</a>
                  <a href="https://academy.hubspot.com/">Sent messages</a>
                  <a href="https://loghin.com/logout">Sign-out</a>
                  </div>
                </div>
              
                   
                {else}
                <button id="myBtn" vlaue="Login">Login</button> |&nbsp;
                {/if}
            ...
            <div class="modal-content">
                <span class="close" onclick="closeMakeOffer();">&times;</span>
              
                  
             <h2 style="text-align:center;">Login</h2>
            <form method="POST">
                <label for="lname">Email</label>
                <input type="text" id="loghin_id" name="loghin_id" class="email" placeholder="Your Email.."style="">
                            
                 <label for="lname">Password</label>
                <input type="password" id="password" name="password" class="pass" placeholder="password.."style="">
                        
        <button type="submit" name="submit" style="background-color: #095ba7;
        color: white;padding: 12px 20px;border: none;border-radius: 4px;cursor: pointer;width:100%;font-family: Tahoma, Geneva, sans-serif;">Submit</button>
