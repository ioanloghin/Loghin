<?php /* Smarty version Smarty-3.1.7, created on 2023-03-24 11:13:28
         compiled from "/home/loghin/public_html/templates/home.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1711259940508ec043eebe37-84251693%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1711259940508ec043eebe37-84251693',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.7',
  'unifunc' => 'content_508ec0443106e',
  'variables' => 
  array (
    'app_page' => 0,
    'app_title' => 0,
...
<?php if ($_valid && !is_callable('content_508ec0443106e')) {function content_508ec0443106e($_smarty_tpl) {?><?php if (!is_callable('smarty_function_stylesheets')) include '/home/loghin/sources/!core/plugins/function.stylesheets.php';
...
?>
					     	...
					     	<option value="<?php ob_start();?><?php echo trim($_smarty_tpl->tpl_vars['v']->value);?>
<?php $_tmp1=ob_get_clean();?><?php if (array_key_exists($_tmp1,$_smarty_tpl->tpl_vars['country_languages']->value)){?><?php ob_start();?><?php echo trim($_smarty_tpl->tpl_vars['v']->value);?>
<?php $_tmp2=ob_get_clean();?><?php echo $_smarty_tpl->tpl_vars['country_languages']->value[$_tmp2];?>
<?php }?>" <?php ob_start();?><?php echo trim($_smarty_tpl->tpl_vars['v']->value);?>
<?php $_tmp3=ob_get_clean();?><?php if ($_smarty_tpl->tpl_vars['country_languages']->value[$_tmp3]==$_smarty_tpl->tpl_vars['browser_lang']->value){?>selected="selected"<?php }?> class="lang"><?php echo $_smarty_tpl->tpl_vars['v']->value;?>
</option>
						...
						<div class="cnt clear">
							...
							<div class="left">
								...
								<div class="clear itemsOverflow">
									<div class="overflow">
									    <?php  $_smarty_tpl->tpl_vars['itemsss'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['itemsss']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['item2']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['itemsss']->key => $_smarty_tpl->tpl_vars['itemsss']->value){
$_smarty_tpl->tpl_vars['itemsss']->_loop = true;
?>
										<ul>
											<li class="clear">
												<label><input type="checkbox" value="<?php echo $_smarty_tpl->tpl_vars['itemsss']->value['id'];?>
" name="suggest" id="" /></label>
												<div class="logo"><img src="uploads/<?php echo $_smarty_tpl->tpl_vars['itemsss']->value['image'];?>
" alt="" width="94" height="74"/></div>
												<div class="details">
													<div class="clear">
												 
														<h3 id="cheading">                       <?php echo $_smarty_tpl->tpl_vars['itemsss']->value['heading'];?>

														</h3>
															
														<span><?php echo $_smarty_tpl->tpl_vars['itemsss']->value['ctime'];?>
                 </span>
													</div>
												<p id="discription"><?php echo $_smarty_tpl->tpl_vars['itemsss']->value['discription'];?>
</p>
												</div>
											</li>
																														</ul>
 ...
 $_from = $_smarty_tpl->tpl_vars['item3']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
										...
										<form method="POST">
												...
												<div class="details">
													<div class="clear">
														<h3 id="maincheck">Assasins Creed <?php echo ($_smarty_tpl->tpl_vars['item3']->value[3]['id']);?>
 </h3>
